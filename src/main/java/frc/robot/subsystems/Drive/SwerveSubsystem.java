...
public class SwerveSubsystem extends SubsystemBase{
    ...
    */
    ...
    public SwerveModuleState[] getSwerveModulesState()
    {
        return new SwerveModuleState[] {
            swerveModules[0].getState(), // Front-Left
            swerveModules[1].getState(), // Front-Right
            swerveModules[2].getState(), // Back-Left
            swerveModules[3].getState()  // Back-Right
        };
    }
}